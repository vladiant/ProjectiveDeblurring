...
void ReturnInterpolatedValueFast(float x, float y, float* Rimg, float* Gimg,
  ...
  R = Rimg[index] * w[0] + Rimg[index + width] * w[1] + Rimg[index + 1] * w[2] +
      Rimg[index + width + 1] * w[3];
  G = Gimg[index] * w[0] + Gimg[index + width] * w[1] + Gimg[index + 1] * w[2] +
      Gimg[index + width + 1] * w[3];
  B = Bimg[index] * w[0] + Bimg[index + width] * w[1] + Bimg[index + 1] * w[2] +
