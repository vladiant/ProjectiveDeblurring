...
RLDeblurrerBilateralReg::RLDeblurrerBilateralReg(
...
void RLDeblurrerBilateralReg::SetBuffer(int width, int height) {
...
void RLDeblurrerBilateralReg::ClearBuffer() {
...
void RLDeblurrerBilateralReg::ProjectiveMotionRLDeblurBilateralRegGray(
...
void RLDeblurrerBilateralReg::ProjectiveMotionRLDeblurBilateralRegRgb(
...
void RLDeblurrerBilateralReg::ComputeBilaterRegImageGray(float* Img, int width,
                                                         int height,
                                                         float* BRImg) {
