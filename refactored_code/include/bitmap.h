...
extern void readBMP(const char* fname, float*& fImgR, float*& fImgG,
                    float*& fImgB, int& width, int& height);
extern void writeBMP(const char* iname, int width, int height,
                     unsigned char* data);
extern void writeBMP(const char* iname, int width, int height, float* data);
extern void writeBMP(const char* iname, int width, int height, float* dataR,
