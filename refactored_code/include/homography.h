...
class Homography {
 public:
  ...
  void ComputeHomography(double correspondantsA[4][2],
                         double correspondantsB[4][2]);
  void ComputeHomography(double correspondantsA[4][2],
                         double correspondantsB[4][2], double** featurevector,
                         double* w, double** v, double* rv1);
  ...
  void ComputeAffineHomography(double correspondantsA[4][2],
                               double correspondantsB[4][2]);
  ...
  void ComputeRTHomography(double correspondantsA[4][2],
                           double correspondantsB[4][2]);
  ...
  void MatrixInverse(float A[3][3], float I[3][3]) {
    double detA = A[0][0] * A[1][1] * A[2][2] + A[1][0] * A[2][1] * A[0][2] +
